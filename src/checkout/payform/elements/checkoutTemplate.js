export default `
<div class="modal">
    <div class="preload"><span class="SVGInline">
          <svg class="SVGInline-svg" xmlns="http://www.w3.org/2000/svg">
            <symbol id="Icon-creditCard-desktop" viewbox="0 0 30 30">
            ...
            <symbol id="Icon-calendar-desktop" viewbox="0 0 30 30">
            ...
            <symbol id="Icon-user-desktop" viewbox="0 0 30 30">
              <title>User</title>
            ...
            <symbol id="Icon-envelope-desktop" viewbox="0 0 30 30">
            ...
            <symbol id="Icon-lock-desktop" viewbox="0 0 30 30">
              <title>Lock</title>
                ...
                <div class="payform--form">
                    <form id="payform" role="form">
                        <fieldset class="payform--fieldset">
                            <div class="payform--group payform--card-holder">
                                <input id="card-holder" type="text" value="" placeholder="Card holder" autocomplete="off" autocorrect="no" autocapitalize="no" spellcheck="no">
                                <div class="payform--icon">
                                    <svg fill="#549928">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#Icon-user-desktop"></use>
                                    </svg>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset class="payform--fieldset">
                            <div class="payform--group payform--card-number">
                                <input id="card-number" type="tel" value="" placeholder="Card number" autocomplete="off"
                                       autocorrect="no" autocapitalize="no" spellcheck="no">
                                <div class="payform--icon">
                                    <svg fill="#549928">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#Icon-creditCard-desktop"></use>
                                    </svg>
                                </div>
                            </div>
                            <div class="payform--group payform--card-expire">
                                <input id="exp-date" type="tel" value="" placeholder="MM / YY" autocomplete="off"
                                       autocorrect="no" autocapitalize="no" spellcheck="no">
                                <div class="payform--icon">
                                    <svg fill="#549928">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#Icon-calendar-desktop"></use>
                                    </svg>
                                </div>
                            </div>
                            <div class="payform--group payform--card-cvc">
                                <input id="cvv" type="tel" value="" placeholder="CVC" autocomplete="off"
                                       autocorrect="no" autocapitalize="no" spellcheck="no" maxlength="4">
                                <div class="payform--icon">
                                    <svg fill="#549928">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#Icon-lock-desktop"></use>
                                    </svg>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset class="payform--fieldset">
                            <div class="payform--group payform--email">
                                <input id="email" type="email" value="" placeholder="Email" autocomplete="email"
                                       autocorrect="no" autocapitalize="no" spellcheck="no">
                                <div class="payform--icon">
                                    <svg fill="#549928">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#Icon-envelope-desktop"></use>
                                    </svg>
                                </div>
                            </div>
                        </fieldset>
                        <div class="error-panel"></div>
                        <button class="payform--pay-button" type="button" form="payform">Оплатить</button>
                    </form>
                    <div class="spinner" style="transform:scale(0.54)">
                    ...
                    <div class="checkmark icon icon--order-success svg">
