...
describe('CheckIntegration', function () {
    ...
    describe('#makeDictionary()', function() {
        it('should return dictionary for matcher', function() {
            const dictionary = 'invoiceAccessToken invoiceID invoiceTemplateID invoiceTemplateAccessToken cistomerID customerAccessToken value logo name label description payButtonLabel popupMode redirectUrl locale opened closed finished applePayTest paymentFlowHold holdExpiration terminals';
