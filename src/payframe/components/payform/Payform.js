        ...
        return (
            <form className={cx('payform--form', {
                ...
                >
                    ...
                    { !this.props.spinner && !this.props.checkmark ? `${this.props.payButtonLabel ? this.props.payButtonLabel.slice(0, 12) : 'Оплатить'} ${this.props.amount} ${this.props.currency}` : false }
                </button>
            </form>
        );
    }
