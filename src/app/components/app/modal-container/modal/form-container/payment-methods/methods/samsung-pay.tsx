...
const TokenProviderFormLink: React.SFC<MethodProps> = (props) => (
    <li className={method} onClick={toTokenProvider.bind(null, props)} id='samsung-pay-payment-method'>
        <SamsungPayIcon/>
        <div className={title}>
            {props.locale['form.payment.method.name.samsung.pay.label']}
        </div>
    </li>
);
...
const SamsungPayLink: React.SFC<MethodProps> = (props) => (
    <li className={method_simple} onClick={pay.bind(null, props)} id='samsung-pay-payment-method'>
        <svg width='100%' height='40' viewBox='-75 0 600 55'>
            <path
