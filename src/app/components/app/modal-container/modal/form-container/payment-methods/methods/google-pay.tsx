...
const TokenProviderFormLink: React.SFC<MethodProps> = (props) => (
    <li className={method} onClick={toTokenProvider.bind(null, props)} id='google-pay-payment-method'>
        <GooglePayIcon/>
        <div className={title}>
            {props.locale['form.payment.method.name.google.pay.label']}
            <hr/>
        </div>
    </li>
);
...
const GooglePayLink: React.SFC<MethodProps> = (props) => (
    <li className={method} onClick={pay.bind(null, props)} id='google-pay-payment-method'>
        <svg viewBox='0 0 435 180' width='100%' height='40'>
            <g fill='none'>
                <path
                ...
                <path
                    ...
                    fill='#34A853'/>
                <path d='M31.58 83.78a43.14 43.14 0 0 1 0-27.56V37.67H7.67a72 72 0 0 0 0 64.66l23.91-18.55z'
                      fill='#FBBC04'/>
                <path
