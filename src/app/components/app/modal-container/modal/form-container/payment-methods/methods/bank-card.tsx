...
import {FormName, ModalForms, ModalName, ModalState, ModelState, SlideDirection} from 'checkout/state';
...
const toBankCard = (props: BankCardProps) => {
    ...
    isBankCardExist ?
        props.navigateToFormInfo(FormName.cardForm, SlideDirection.right)
    :
