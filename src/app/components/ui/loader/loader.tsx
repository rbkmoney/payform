...
import { themes, Theme } from 'checkout/themes';

const LoaderDef: React.FC<{ theme: Theme }> = ({ theme }) => (
    <svg className={cx(styles.loader)} width="57px" height="57px" viewBox="0 0 57 57">
        <defs>
            <linearGradient x1="100%" y1="0%" x2="0%" y2="100%" id="linearGradientCrab">
                <stop stopColor="#7854CD" offset="0%" />
                <stop stopColor="#FF8353" offset="100%" />
            </linearGradient>
            <linearGradient x1="100%" y1="0%" x2="0%" y2="100%" id="linearGradientMain">
        ...
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g
                ...
                strokeWidth="4"
                stroke={`url(#linearGradient${theme.name === themes.main.name ? 'Main' : 'Crab'})`}>
