...
export function* bankCardToMethods(bankCard: BankCard, config: ConfigState, amountInfo: AmountInfoState): Iterator<CallEffect | PaymentMethodState[]> {
